...
"cygwin-thread-multi-2.8.1(0.31253)" or
	die "Errno architecture (cygwin-thread-multi-2.8.1(0.31253)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
